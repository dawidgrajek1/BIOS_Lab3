...
if RNAorProtein == 0:
  ...
  with open('RNAoutcome.txt', 'w') as f:
    ...
    while i < len(residues):
        ...
        n = get_atom_vector(residue, "N9" if residue_name == 'A' or residue_name == 'G' else "N1")
        ...
        chi = calculate_dihedral(o4, c1, n, c4w if residue_name == 'A' or residue_name == 'G' else c2w)
